...
public class Main {
    ...
    public static void FCFS(LinkedList<MyProcess> processes) {

        processes.sort(new FcfsComparator());
    ...
    public static void main(String[] args) {
        ...
        processes.add(new MyProcess("p1", 2, 5));
        processes.add(new MyProcess("p2", 1, 3));
        processes.add(new MyProcess("p3", 3, 2));
        processes.add(new MyProcess("p4", 4, 2));


        for (MyProcess process : sortedProcesses) {
            String command = "java";
